      ...
      <div class="container-fluid">
         <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php">
               ...
               <span class="hidden-sm">SoftNEY</span>
            </a>
         </div>
         ...
         <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
               ...
               <li>
                  <a  target="_blank" class="bg-primary" title="Desarrolladores">
                     <span class="glyphicon glyphicon-upload hidden-xs"></span>
                     <span class="visible-xs">Desarolladores </span>
                      <span class="visible-xs">Emily Ledezma</span>
                       <span class="visible-xs">Nestor Erazo</span>
                        <span class="visible-xs">Yovan Quintero</span>
                  </a>
               </li>
               <?php } ?>
