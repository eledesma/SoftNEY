...
<div class="well">
   <div class="page-header" style="margin-top: 0px;">
      <h1>
         Bienvenido a SoftNEY
         <small><?php echo $fsc->version();?></small>
      </h1>
   </div>
   <p class="help-block">
      Ya tienes instalado el poder de SoftNEY.Utiliza tu propio plugns y saca el mayor Rendimiento
   </p>
...
<div class="container-fluid" style="margin-top: 10px;">
   <div class="row">
      ...
      <div class="col-xs-6 text-right">
         <h2 style="margin-top: 0px;">Panel  Principal</h2>
      </div>
   </div>
</div>
<?php } ?>
      ...
      <div role="tabpanel" class="tab-pane" id="t_plugins">
         <div class="table-responsive">
            <table class="table table-hover">
               ...
               <tr class="warning">
                  <td colspan="5">No tienes plugins instalados. <b>Crea tu Plugins Personalizado</b>.</td>
               </tr>
               <?php } ?>
