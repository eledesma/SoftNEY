   ...
   <nav class="navbar navbar-default" role="navigation" style="margin: 0px;">
      <div class="container-fluid">
         <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php">SoftNEY</a>
         </div>
            ...
            <ul class="nav navbar-nav navbar-right">
               <li>
                  ...
                  <ul class="dropdown-menu">
                     <li><a target="_blank">Emily Ledezma</a></li>
   ...
   <div class="container">
      <div class="row">
         <div class="col-sm-12">
            <div class="page-header">
               <h1>
                  Bienvenido al instalador De SoftNEY
         ...
         <div class="col-sm-12">
            ...
            <div class="panel panel-danger">
               ...
               <div class="panel-body">
                  <p>
                     La carpeta de SoftNEY no tiene permisos de escritura. Sin esos
                     permisos, no funcionará SoftNEY.
                  </p>
            ...
            <div class="panel panel-danger">
               ...
               <div class="panel-body">
                  <p>
                     SoftNEY necesita PHP 5.3 o superior, y tú estás usando <?php echo phpversion() ?>.
                  </p>
            ...
            <div class="panel panel-danger">
               ...
               <div class="panel-body">
                  <p>
                     SoftNEY necesita la extensión mbstring para poder trabajar con caracteres
            ...
            <div class="panel panel-danger">
               ...
               <div class="panel-body">
                  <p>
                     SoftNEY necesita la extensión OpenSSL para poder descargar plugins,
            ...
            <div class="panel panel-danger">
               ...
               <div class="panel-body">
                  <p>
                    SoftNEY necesita la extensión ZipArchive para poder
      ...
      <div class="row">
         <div class="col-sm-10">
            ...
            <p class="help-block">
               Recuerda que tienes el menú Desarrolladores arriba a la derecha. 
               Recuerda No sabemos hacer software perfecto, pero con tu ayuda nos podemos acercar cada vez más ;-)
               <br/><br/>
               Y si quieres saber más, no olvides seguir a nuestros desarrolladores principal
               en su canal de youtube.
            </p>
            <a href="https://www.youtube.com/" target="_blank" class="btn btn-sm btn-default">
               <span class="glyphicon glyphicon-facetime-video"></span> &nbsp; SoftNEY en YouTube
            </a>
         </div>
         <div class="col-sm-2">
            <div class="thumbnail">
      ...
      <div class="row" style="margin-bottom: 20px;">
         <div class="col-sm-12 text-center">
            <hr/>
            <small>
               © 2016 <a target="_blank" href="https:#">SoftNEY</a>
            </small>
         </div>
      </div>
   </div>
